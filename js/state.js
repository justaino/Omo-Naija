// state.js — the single source of truth for Omo Naija.
...
const STORAGE_KEY = 'omo-naija:state';

// Team colours, handed out in order as teams are added at setup.
...
export function freshState() {
  return {
    ...
    deck: [],                    // remaining draw pile: [{id,text,hint,category,era,mode}]
